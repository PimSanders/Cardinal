        ...
        <el-table :data="teamList" style="width: 100%" stripe v-loading="teamList === null">
            ...
            <el-table-column :label="$t('general.operate')">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="warning" slot="reference" @click="onResetPassword(scope.row.ID)">{{$t('team.reset_password')}}</el-button>
                    <el-button size="mini" type="danger" slot="reference" @click="handleDelete(scope.row)">{{$t('general.delete')}}</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="$t('team.edit')" :visible.sync="editTeamDialogVisible">
            <el-form label-width="80px">
                ...
                <el-form-item>
                    ...
                    <el-button slot="reference" @click="onResetPassword(editTeamForm.ID)">{{$t('team.reset_password')}}</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
